...
**`fx-upgrade` performs this migration** — it is intentionally intrusive and asks for confirmation first. `fx-setup` only creates what is missing and will refuse to touch a legacy layout. The table below is what upgrade applies.
